        ...
        <div class="modal-content">
            <form id="form_<?= htmlentities($id) ?>">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7 form-group">
                            <input type="text" id="input-iframe_name" value="" name="iframe_name" class="form-control" required>
                            <div id="error"></div>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7 form-group">
                            <select class="col-sm-7 form-select example-basic-single" id="input-iframe_type" name="iframe_type" aria-label="Default select example">
                                <option selected value="1">Metabase - Dashboard</option>
                                <option value="2">Metabase - Question</option>
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-7 form-group">
                            <!-- <input type="text" id="input-iframe_tag" value="" name="iframe_tag" class="form-control" required> -->
                            <textarea name="iframe_tag" id="input-iframe_tag" cols="45" rows="10"></textarea>
                            <div id="error"></div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" data="<?= htmlentities($id) ?>" onclick="save_iframe(this)" class="btn btn-primary">SAVE CHANGES</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    function save_iframe(data) {
        ...
        if (validated.validate) {
            ...
            $.ajax({
                url: '<?= htmlentities(base_url('Parameter/Manage_Iframe_c/check_iframe_name/')) ?>',
                type: "post",
                data: val,
                beforeSend: function() {
                    $("#loader").show();
                ...
                success: function(res) {
                    ...
                    if (response.res == '1') {
                        swal.fire("", "Harap Periksa kembali, Iframe Name sudah ada", "warning");
                    } else {
