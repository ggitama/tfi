        ...
        <div class="modal-content">
            <form id="form_<?= htmlentities($id) ?>">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" data="<?= htmlentities($id) ?>" onclick="editStockDaysFam(this)" class="btn btn-primary">SAVE CHANGES</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    function editStockDaysFam(data) {
        ...
        if (validated.validate) {
            ...
            $.ajax({
                url: '<?= htmlentities(base_url('Parameter/Stock_Days_c0001/edit_sdFam/')) ?>',
                type: "post",
                data: val,
                beforeSend: function() {
                    $("#loader").show();
                ...
                success: function(res) {
                    ...
                    if (response.value == '0') {
                        ...
                        Swal.fire({
                            ...
                            // Reload the Page
                            // location.reload();
                            $("#modal_edit_fam_stock_day").modal('hide');
                            $("#modal_edit_fam_stock_day").remove();
