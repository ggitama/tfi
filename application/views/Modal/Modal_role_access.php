                    ...
                    <table class="table table-bordered table-striped align-middle">
                        <tbody>
                            ...
                            <tr class="text-center">
                                ...
                                <th colspan="4">
                                    <input class="form-check-input" type="checkbox" value="" id="selectParent"> Select All
                                </th>
                            </tr>
                            ...
                            <?php foreach ($level_detail2 as $row3) : ?>
                                <?php if ($row3['id_role'] == $role_id) : ?>
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            <input class="form-check-input parentss" type="checkbox" id="<?= htmlentities($row3['id_menu']) ?>" name="view[]" value="<?= htmlentities($role_id) . '-' . htmlentities($row3['id_menu']) . '-' . '1' ?>" id="flexCheckDefault" <?= htmlentities(($row3['id_role']) == htmlentities($role_id) && htmlentities($row3['view']) == 1) ? 'checked' : ''; ?>> view
                                        </td>
                                    </tr>
                                <?php endif; ?>
                            <?php endforeach; ?>
                            ...
                            ?>
                                <?php foreach ($row4 as $row5) { ?>
                                    <tr class="text-center">
                                        ...
                                        <th colspan="4">
                                            <input class="form-check-input" type="checkbox" value="" id="selectAll<?= htmlentities($row5['id_menu']) ?>"> Select All
                                        </th>
                                    </tr>
                                        ...
                                        <?php foreach ($row6 as $row7) : ?>
                                            <?php if ($row7['parent'] ==  $row5['id_menu'] && $row7['id_role'] == $role_id) : ?>
                                                <tr class="text-center">
                                                    ...
                                                    <td>
                                                        <input class="form-check-input child<?= htmlentities($row5['id_menu']) ?>" type="checkbox" name="view[]" value="<?= htmlentities($role_id) . '-' . htmlentities($row7['id_menu']) . '-' . '1' ?>" id="" <?= htmlentities(($row7['id_role']) == htmlentities($role_id) && htmlentities($row7['view']) == 1) ? 'checked' : ''; ?>> view
                                                    </td>
                                                </tr>
                                            <?php endif; ?>
                                        <?php endforeach; ?>
