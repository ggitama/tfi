...
class National_c extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['menus'] = $menu;
        $data['title'] = 'Management Overview';
        $data['menu_header'] = 'Dashboard Commercial';
        $data['main_menu'] = 'Management Overview';

        $this->load->view('template_dashboard/Header_v', $data);
        $this->load->view('Commercial/National_v', $data);
