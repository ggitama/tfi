...
class REGIONAL_JAKARTA_3 extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['menus'] = $menu;
        $data['title'] = 'REGIONAL JAKARTA 3';
        $data['menu_header'] = 'Dashboard';
        $data['main_menu'] = 'REGIONAL JAKARTA 3';

        $this->load->view('template_dashboard/Header_v', $data);
        $this->load->view('Regional/REGIONAL_JAKARTA_3_v', $data);
