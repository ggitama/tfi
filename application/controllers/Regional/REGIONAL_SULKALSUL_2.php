...
class REGIONAL_SULKALSUL_2 extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['menus'] = $menu;
        $data['title'] = 'REGIONAL SULKALSUL 2';
        $data['menu_header'] = 'Dashboard';
        $data['main_menu'] = 'REGIONAL SULKALSUL 2';

        $this->load->view('template_dashboard/Header_v', $data);
        $this->load->view('Regional/REGIONAL_SULKALSUL_2_v', $data);
