...
class REGIONAL_SUMKALSUL_2 extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['menus'] = $menu;
        $data['title'] = 'REGIONAL SUMKALSUL 2';
        $data['menu_header'] = 'Dashboard';
        $data['main_menu'] = 'REGIONAL SUMKALSUL 2';

        $this->load->view('template_dashboard/Header_v', $data);
        $this->load->view('Regional/REGIONAL_SUMKALSUL_2_v', $data);
