...
class REGIONAL_SUMKALSUL_3 extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['menus'] = $menu;
        $data['title'] = 'REGIONAL SUMKALSUL 3';
        $data['menu_header'] = 'Dashboard';
        $data['main_menu'] = 'REGIONAL SUMKALSUL 3';

        $this->load->view('template_dashboard/Header_v', $data);
        $this->load->view('Regional/REGIONAL_SUMKALSUL_3_v', $data);
