...
class REGIONAL_SUMKALSUL_1 extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['menus'] = $menu;
        $data['title'] = 'REGIONAL SUMKALSUL 1';
        $data['menu_header'] = 'Dashboard';
        $data['main_menu'] = 'REGIONAL SUMKALSUL 1';

        $this->load->view('template_dashboard/Header_v', $data);
        $this->load->view('Regional/REGIONAL_SUMKALSUL_1_v', $data);
