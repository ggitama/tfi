...
class REGIONAL_JAKARTA_4 extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['menus'] = $menu;
        $data['title'] = 'REGIONAL JAKARTA 4';
        $data['menu_header'] = 'Dashboard';
        $data['main_menu'] = 'REGIONAL JAKARTA 4';

        $this->load->view('template_dashboard/Header_v', $data);
        $this->load->view('Regional/REGIONAL_JAKARTA_4_v', $data);
