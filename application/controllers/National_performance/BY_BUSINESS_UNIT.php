...
class BY_BUSINESS_UNIT extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['menus'] = $menu;
        $data['title'] = 'BY BUSINESS UNIT';
        $data['menu_header'] = 'Dashboard';
        $data['main_menu'] = 'BY BUSINESS UNIT';

        $this->load->view('template_dashboard/Header_v', $data);
        $this->load->view('National_performance/By_Business_unit_v', $data);
