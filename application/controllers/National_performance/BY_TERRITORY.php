...
class BY_TERRITORY extends CI_Controller
{
    ...
    public function index()
    {
        ...
        // var_dump($get_data_iframe->iframe_name);die;
        if ($get_data_iframe) {
        ...
        $data['menus'] = $menu;
        $data['title'] = 'BY TERRITORY';
        $data['menu_header'] = 'Dashboard';
        $data['main_menu'] = 'BY TERRITORY';

        $this->load->view('template_dashboard/Header_v', $data);
        $this->load->view('National_performance/By_Territory_v', $data);
