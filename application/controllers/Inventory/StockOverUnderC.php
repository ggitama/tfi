...
class StockOverUnderC extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['menus'] = $menu;
        $data['title'] = 'Stock (Over/Under)';
        $data['menu_header'] = 'Dashboard Iventory';
        $data['main_menu'] = 'Stock (Over/Under)';

        $this->load->view('template_dashboard/Header_v', $data);
        $this->load->view('Inventory/StockOverUnderV', $data);
