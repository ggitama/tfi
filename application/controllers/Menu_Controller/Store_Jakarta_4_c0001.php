<?php
        ...
        class Store_Jakarta_4_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Store Jakarta 4';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Store Jakarta 4';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Store_Jakarta_4_v0001', $data);
