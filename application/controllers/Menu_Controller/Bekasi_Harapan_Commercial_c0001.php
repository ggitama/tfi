<?php
        ...
        class Bekasi_Harapan_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Bekasi Harapan Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Bekasi Harapan Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Bekasi_Harapan_Commercial_v0001', $data);
