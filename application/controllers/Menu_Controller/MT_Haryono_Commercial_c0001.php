<?php
        ...
        class MT_Haryono_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'MT Haryono Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'MT Haryono Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/MT_Haryono_Commercial_v0001', $data);
