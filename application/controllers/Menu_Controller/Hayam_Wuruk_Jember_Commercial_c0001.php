<?php
        ...
        class Hayam_Wuruk_Jember_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Hayam Wuruk Jember Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Hayam Wuruk Jember Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Hayam_Wuruk_Jember_Commercial_v0001', $data);
