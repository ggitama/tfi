<?php
        ...
        class Cempaka_Putih_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Cempaka Putih Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Cempaka Putih Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Cempaka_Putih_Commercial_v0001', $data);
