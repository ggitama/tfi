<?php
        ...
        class Panakukang_Makassar_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Panakukang Makassar Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Panakukang Makassar Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Panakukang_Makassar_Inventory_v0001', $data);
