<?php
        ...
        class Solo_Paragon_Commercial_c0002 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Solo Paragon Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Solo Paragon Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Solo_Paragon_Commercial_v0002', $data);
