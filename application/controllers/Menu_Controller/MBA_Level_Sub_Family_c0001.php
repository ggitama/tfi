<?php
        ...
        class MBA_Level_Sub_Family_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                if ($get_data_iframe) {
                    ...
                    $data['iframe_tag'] = '<iframe title="Report Section" width="97%" height="4000" src="https://app.powerbi.com/view?r=eyJrIjoiNTU4OTMwMDUtYTMxZi00NjkwLWI5YjktYzJkMjNmNzBjOTg3IiwidCI6ImY2NjIxNTQ3LTI3MjQtNDU0Ny1iYzA3LTZlNTA3ZjYxMmVhNiIsImMiOjEwfQ%3D%3D" frameborder="0" allowFullScreen="true"></iframe>';
                } else {
                    $data['iframe_name'] = '';
                ...
                $data['menus'] = $menu;
                $data['title'] = 'MBA Level Sub-Family';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'MBA Level Sub-Family';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/MBA_Level_Sub-Family_v0001', $data);
