<?php
        ...
        class Rungkut_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Rungkut Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Rungkut Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Rungkut_Inventory_v0001', $data);
