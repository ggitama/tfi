<?php
        ...
        class Season_City_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Season City Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Season City Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Season_City_Commercial_v0001', $data);
