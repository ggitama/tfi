<?php
        ...
        class Tangerang_City_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Tangerang City Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Tangerang City Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Tangerang_City_Inventory_v0001', $data);
