<?php
        ...
        class Graha_Bintaro_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Graha Bintaro Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Graha Bintaro Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Graha_Bintaro_Commercial_v0001', $data);
