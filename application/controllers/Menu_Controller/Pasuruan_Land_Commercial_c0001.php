<?php
        ...
        class Pasuruan_Land_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Pasuruan Land Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Pasuruan Land Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Pasuruan_Land_Commercial_v0001', $data);
