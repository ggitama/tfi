<?php
        ...
        class Maguwo_Yogyakarta_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Maguwo Yogyakarta Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Maguwo Yogyakarta Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Maguwo_Yogyakarta_Commercial_v0001', $data);
