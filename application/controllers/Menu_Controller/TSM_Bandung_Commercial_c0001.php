<?php
        ...
        class TSM_Bandung_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'TSM Bandung Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'TSM Bandung Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/TSM_Bandung_Commercial_v0001', $data);
