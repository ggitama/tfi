<?php
        ...
        class RAW_Daily_Stock_Aging_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'RAW Daily Stock Aging';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'RAW Daily Stock Aging';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/RAW_Daily_Stock_Aging_v0001', $data);
