<?php
        ...
        class Solo_Paragon_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Solo Paragon Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Solo Paragon Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Solo_Paragon_Inventory_v0001', $data);
