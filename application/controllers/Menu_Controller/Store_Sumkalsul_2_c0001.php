<?php
        ...
        class Store_Sumkalsul_2_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Store Sumkalsul 2';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Store Sumkalsul 2';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Store_Sumkalsul_2_v0001', $data);
