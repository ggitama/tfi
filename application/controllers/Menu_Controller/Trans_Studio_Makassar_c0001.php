<?php
        ...
        class Trans_Studio_Makassar_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Trans Studio Makassar';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Trans Studio Makassar';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Trans_Studio_Makassar_v0001', $data);
