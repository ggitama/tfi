<?php
        ...
        class Surabaya_Dukuh_Kupang_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Surabaya Dukuh Kupang Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Surabaya Dukuh Kupang Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Surabaya_Dukuh_Kupang_Commercial_v0001', $data);
