<?php
        ...
        class Telogo_Rejo_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Telogo Rejo Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Telogo Rejo Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Telogo_Rejo_Inventory_v0001', $data);
