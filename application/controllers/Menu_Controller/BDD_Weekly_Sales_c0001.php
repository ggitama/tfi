<?php
        ...
        // tes
        class BDD_Weekly_Sales_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'BDD Weekly Sales';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'BDD Weekly Sales';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/BDD_Weekly_Sales_v0001', $data);
