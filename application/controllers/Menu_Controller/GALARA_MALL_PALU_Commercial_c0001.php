<?php
        ...
        class GALARA_MALL_PALU_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'GALARA MALL PALU Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'GALARA MALL PALU Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/GALARA_MALL_PALU_Commercial_v0001', $data);
