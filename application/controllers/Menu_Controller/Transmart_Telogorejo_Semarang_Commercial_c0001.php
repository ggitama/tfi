<?php
        ...
        class Transmart_Telogorejo_Semarang_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Transmart Telogorejo Semarang Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Transmart Telogorejo Semarang Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Transmart_Telogorejo_Semarang_Commercial_v0001', $data);
