<?php
        ...
        class Duta_Merlin_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Duta Merlin Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Duta Merlin Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Duta_Merlin_Commercial_v0001', $data);
