<?php
        ...
        class REGIONAL_MANADO_MULTIMART_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'REGIONAL MANADO & MULTIMART';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'REGIONAL MANADO & MULTIMART';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/REGIONAL_MANADO_MULTIMART_v0001', $data);
