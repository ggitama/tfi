<?php
        ...
        class Example_with_child_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Example with child';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Example with child';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Example_with_child_v0001', $data);
