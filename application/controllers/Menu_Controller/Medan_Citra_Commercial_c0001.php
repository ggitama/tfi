<?php
        ...
        class Medan_Citra_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Medan Citra Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Medan Citra Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Medan_Citra_Commercial_v0001', $data);
