<?php
        ...
        class Palembang_City_Center_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Palembang City Center Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Palembang City Center Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Palembang_City_Center_Commercial_v0001', $data);
