<?php
        ...
        class BDD_Daily_Stock_Aging_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'BDD Daily Stock Aging';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'BDD Daily Stock Aging';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/BDD_Daily_Stock_Aging_v0001', $data);
