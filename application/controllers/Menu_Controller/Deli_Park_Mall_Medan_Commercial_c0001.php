<?php
        ...
        class Deli_Park_Mall_Medan_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Deli Park Mall Medan Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Deli Park Mall Medan Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Deli_Park_Mall_Medan_Commercial_v0001', $data);
