<?php
        ...
        class Buah_Batu_Bandung_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Buah Batu Bandung Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Buah Batu Bandung Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Buah_Batu_Bandung_Commercial_v0001', $data);
