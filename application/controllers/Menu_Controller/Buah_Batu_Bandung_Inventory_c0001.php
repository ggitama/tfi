<?php
        ...
        class Buah_Batu_Bandung_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Buah Batu Bandung Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Buah Batu Bandung Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Buah_Batu_Bandung_Inventory_v0001', $data);
