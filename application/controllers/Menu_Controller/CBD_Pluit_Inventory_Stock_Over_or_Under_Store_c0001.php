<?php
        ...
        class CBD_Pluit_Inventory_Stock_Over_or_Under_Store_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'CBD Pluit Inventory Stock Over or Under Store';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'CBD Pluit Inventory Stock Over or Under Store';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/CBD_Pluit_Inventory_Stock_Over_or_Under_Store_v0001', $data);
