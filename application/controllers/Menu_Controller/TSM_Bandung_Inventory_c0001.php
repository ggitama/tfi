<?php
        ...
        class TSM_Bandung_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'TSM Bandung Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'TSM Bandung Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/TSM_Bandung_Inventory_v0001', $data);
