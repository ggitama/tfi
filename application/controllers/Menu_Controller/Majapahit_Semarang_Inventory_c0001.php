<?php
        ...
        class Majapahit_Semarang_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Majapahit Semarang Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Majapahit Semarang Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Majapahit_Semarang_Inventory_v0001', $data);
