<?php
        ...
        class Store_New_test_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Store New test';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Store New test';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Store_New_test_v0001', $data);
