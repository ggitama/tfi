<?php
        ...
        class Bintaro_Jakarta_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Bintaro Jakarta Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Bintaro Jakarta Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Bintaro_Jakarta_Inventory_v0001', $data);
