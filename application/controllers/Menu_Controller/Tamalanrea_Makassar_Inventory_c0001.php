<?php
        ...
        class Tamalanrea_Makassar_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Tamalanrea Makassar Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Tamalanrea Makassar Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Tamalanrea_Makassar_Inventory_v0001', $data);
