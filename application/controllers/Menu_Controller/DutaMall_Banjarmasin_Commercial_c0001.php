<?php
        ...
        class DutaMall_Banjarmasin_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'DutaMall Banjarmasin Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'DutaMall Banjarmasin Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/DutaMall_Banjarmasin_Commercial_v0001', $data);
