<?php
        ...
        class Magelang_Armada_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Magelang Armada Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Magelang Armada Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Magelang_Armada_Inventory_v0001', $data);
