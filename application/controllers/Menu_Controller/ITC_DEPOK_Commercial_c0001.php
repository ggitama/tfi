<?php
        ...
        class ITC_DEPOK_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'ITC DEPOK Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'ITC DEPOK Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/ITC_DEPOK_Commercial_v0001', $data);
