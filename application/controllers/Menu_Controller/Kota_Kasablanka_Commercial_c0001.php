<?php
        ...
        class Kota_Kasablanka_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Kota Kasablanka Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Kota Kasablanka Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Kota_Kasablanka_Commercial_v0001', $data);
