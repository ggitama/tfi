<?php
        ...
        class Cipinang_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Cipinang Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Cipinang Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Cipinang_Commercial_v0001', $data);
