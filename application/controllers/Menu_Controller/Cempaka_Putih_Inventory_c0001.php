<?php
        ...
        class Cempaka_Putih_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Cempaka Putih Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Cempaka Putih Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Cempaka_Putih_Inventory_v0001', $data);
