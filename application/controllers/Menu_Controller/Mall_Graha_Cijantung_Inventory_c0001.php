<?php
        ...
        class Mall_Graha_Cijantung_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Mall Graha Cijantung Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Mall Graha Cijantung Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Mall_Graha_Cijantung_Inventory_v0001', $data);
