<?php
        ...
        class Transmart_Ngagel_Surabaya_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Transmart Ngagel Surabaya Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Transmart Ngagel Surabaya Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Transmart_Ngagel_Surabaya_Commercial_v0001', $data);
