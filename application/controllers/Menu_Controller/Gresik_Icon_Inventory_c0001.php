<?php
        ...
        class Gresik_Icon_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Gresik Icon Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Gresik Icon Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Gresik_Icon_Inventory_v0001', $data);
