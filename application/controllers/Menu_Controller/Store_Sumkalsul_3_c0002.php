<?php
        ...
        class Store_Sumkalsul_3_c0002 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Store Sumkalsul 3';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Store Sumkalsul 3';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Store_Sumkalsul_3_v0002', $data);
