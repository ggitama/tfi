<?php
        ...
        class Sunter_Jakarta_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Sunter Jakarta Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Sunter Jakarta Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Sunter_Jakarta_Commercial_v0001', $data);
