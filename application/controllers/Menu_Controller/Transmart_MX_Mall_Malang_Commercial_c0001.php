<?php
        ...
        class Transmart_MX_Mall_Malang_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Transmart MX Mall Malang Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Transmart MX Mall Malang Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Transmart_MX_Mall_Malang_Commercial_v0001', $data);
