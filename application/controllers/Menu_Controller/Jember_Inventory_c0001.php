<?php
        ...
        class Jember_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Jember Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Jember Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Jember_Inventory_v0001', $data);
