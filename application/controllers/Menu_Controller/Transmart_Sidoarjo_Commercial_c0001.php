<?php
        ...
        class Transmart_Sidoarjo_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Transmart Sidoarjo Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Transmart Sidoarjo Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Transmart_Sidoarjo_Commercial_v0001', $data);
