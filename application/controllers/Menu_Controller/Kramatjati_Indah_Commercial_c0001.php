<?php
        ...
        class Kramatjati_Indah_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Kramatjati Indah Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Kramatjati Indah Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Kramatjati_Indah_Commercial_v0001', $data);
