<?php
        ...
        class Taman_Palem_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Taman Palem Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Taman Palem Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Taman_Palem_Commercial_v0001', $data);
