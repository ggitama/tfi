<?php
        ...
        class BDD_Supplier_Aging_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'BDD Supplier Aging';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'BDD Supplier Aging';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/BDD_Supplier_Aging_v0001', $data);
