<?php
        ...
        class Store_-_Management_Overview_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Store - Management Overview';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Store - Management Overview';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Store_-_Management_Overview_v0001', $data);
