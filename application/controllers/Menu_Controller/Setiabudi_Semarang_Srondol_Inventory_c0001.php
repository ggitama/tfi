<?php
        ...
        class Setiabudi_Semarang_Srondol_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Setiabudi Semarang Srondol Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Setiabudi Semarang Srondol Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Setiabudi_Semarang_Srondol_Inventory_v0001', $data);
