<?php
        ...
        class Medan_Fair_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Medan Fair Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Medan Fair Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Medan_Fair_Inventory_v0001', $data);
