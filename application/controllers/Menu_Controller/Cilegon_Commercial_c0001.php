<?php
        ...
        class Cilegon_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Cilegon Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Cilegon Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Cilegon_Commercial_v0001', $data);
