<?php
        ...
        class Pengayoman_Makassar_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Pengayoman Makassar Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Pengayoman Makassar Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Pengayoman_Makassar_Inventory_v0001', $data);
