<?php
        ...
        class TERRITORY_SUMKALSUL_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'TERRITORY SUMKALSUL';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'TERRITORY SUMKALSUL';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/TERRITORY_SUMKALSUL_v0001', $data);
