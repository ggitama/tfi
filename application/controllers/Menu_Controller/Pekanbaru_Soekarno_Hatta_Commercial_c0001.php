<?php
        ...
        class Pekanbaru_Soekarno_Hatta_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Pekanbaru Soekarno Hatta Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Pekanbaru Soekarno Hatta Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Pekanbaru_Soekarno_Hatta_Commercial_v0001', $data);
