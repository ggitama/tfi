<?php
        ...
        class Store_Jakarta_2_c0002 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Store Jakarta 2';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Store Jakarta 2';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Store_Jakarta_2_v0002', $data);
