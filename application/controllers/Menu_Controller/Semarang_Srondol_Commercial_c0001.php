<?php
        ...
        class Semarang_Srondol_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Semarang Srondol Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Semarang Srondol Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Semarang_Srondol_Commercial_v0001', $data);
