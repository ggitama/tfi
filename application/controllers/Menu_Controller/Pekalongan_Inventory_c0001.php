<?php
        ...
        class Pekalongan_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Pekalongan Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Pekalongan Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Pekalongan_Inventory_v0001', $data);
