<?php
        ...
        class SKU_Comparison_BM_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                if ($get_data_iframe) {
                    ...
                    $data['iframe_tag'] = $template_iframe->tag_open . "https://app.powerbi.com/view?r=eyJrIjoiOTY2MmFhZTMtZDZlMC00YmMwLWE0MjQtMGM0OGI1M2ZlZTgzIiwidCI6ImY2NjIxNTQ3LTI3MjQtNDU0Ny1iYzA3LTZlNTA3ZjYxMmVhNiIsImMiOjEwfQ%3D%3D'" . $template_iframe->width . $template_iframe->height . $template_iframe->attributes . $template_iframe->tag_close;
                } else {
                    $data['iframe_name'] = '';
                ...
                $data['menus'] = $menu;
                $data['title'] = 'SKU Comparison BM';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'SKU Comparison BM';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/SKU_Comparison_BM_v0001', $data);
