<?php
        ...
        class Kawanua_Manado_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Kawanua Manado Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Kawanua Manado Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Kawanua_Manado_Inventory_v0001', $data);
