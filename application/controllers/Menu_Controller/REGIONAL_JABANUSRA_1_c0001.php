<?php
        ...
        class REGIONAL_JABANUSRA_1_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'REGIONAL JABANUSRA 1';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'REGIONAL JABANUSRA 1';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/REGIONAL_JABANUSRA_1_v0001', $data);
