<?php
        ...
        class MBA_Level_Family_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                if ($get_data_iframe) {
                    ...
                    $data['iframe_tag'] = '<iframe title="Report Section" width="97%" height="4000" src="https://app.powerbi.com/view?r=eyJrIjoiMmQ3OWUzNTgtMmQxMC00MjU3LThhY2ItNDBhYmY3YTMxNTA0IiwidCI6ImY2NjIxNTQ3LTI3MjQtNDU0Ny1iYzA3LTZlNTA3ZjYxMmVhNiIsImMiOjEwfQ%3D%3D" frameborder="0" allowFullScreen="true"></iframe>';
                } else {
                    $data['iframe_name'] = '';
                ...
                $data['menus'] = $menu;
                $data['title'] = 'MBA Level Family';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'MBA Level Family';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/MBA_Level_Family_v0001', $data);
