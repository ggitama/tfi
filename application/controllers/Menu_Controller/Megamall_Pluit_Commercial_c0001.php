<?php
        ...
        class Megamall_Pluit_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Megamall Pluit Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Megamall Pluit Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Megamall_Pluit_Commercial_v0001', $data);
