<?php
        ...
        class Pangkal_Pinang_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Pangkal Pinang Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Pangkal Pinang Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Pangkal_Pinang_Inventory_v0001', $data);
