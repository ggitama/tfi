<?php
        ...
        class RAW_GFK_Weekly_Sales_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'RAW GFK Weekly Sales';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'RAW GFK Weekly Sales';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/RAW_GFK_Weekly_Sales_v0001', $data);
