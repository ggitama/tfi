<?php
        ...
        class Cilandak_Inventory_c0002 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Cilandak Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Cilandak Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Cilandak_Inventory_v0002', $data);
