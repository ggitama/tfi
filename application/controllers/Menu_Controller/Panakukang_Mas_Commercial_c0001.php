<?php
        ...
        class Panakukang_Mas_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Panakukang Mas Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Panakukang Mas Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Panakukang_Mas_Commercial_v0001', $data);
