<?php
        ...
        class National_Type_1_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'National Type 1';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'National Type 1';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/National_Type_1_v0001', $data);
