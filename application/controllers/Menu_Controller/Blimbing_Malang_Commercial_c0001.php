<?php
        ...
        class Blimbing_Malang_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Blimbing Malang Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Blimbing Malang Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Blimbing_Malang_Commercial_v0001', $data);
