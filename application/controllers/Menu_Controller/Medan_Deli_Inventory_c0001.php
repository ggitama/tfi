<?php
        ...
        class Medan_Deli_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Medan Deli Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Medan Deli Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Medan_Deli_Inventory_v0001', $data);
