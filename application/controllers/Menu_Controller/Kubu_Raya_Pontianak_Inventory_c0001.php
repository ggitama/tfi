<?php
        ...
        class Kubu_Raya_Pontianak_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Kubu Raya Pontianak Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Kubu Raya Pontianak Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Kubu_Raya_Pontianak_Inventory_v0001', $data);
