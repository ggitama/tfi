<?php
        ...
        class Store_Jabanusra_1_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Store Jabanusra 1';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Store Jabanusra 1';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Store_Jabanusra_1_v0001', $data);
