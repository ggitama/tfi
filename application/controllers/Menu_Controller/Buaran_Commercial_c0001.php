<?php
        ...
        class Buaran_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Buaran Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Buaran Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Buaran_Commercial_v0001', $data);
