<?php
        ...
        class BDD_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                if ($get_data_iframe) {
                    ...
                    $data['iframe_tag'] = $template_iframe->tag_open . "https://transmart.bankmega.com/public/question/645e6850-4bb5-4910-9f38-6a8ab2a9ff46'" . $template_iframe->width . $template_iframe->height . $template_iframe->attributes . $template_iframe->tag_close;
                } else {
                    $data['iframe_name'] = '';
                ...
                $this->load->view('Menu_View/BDD_v0001', $data);
