<?php
        ...
        class Blue_Mall_Bekasi_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Blue Mall Bekasi Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Blue Mall Bekasi Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Blue_Mall_Bekasi_Commercial_v0001', $data);
