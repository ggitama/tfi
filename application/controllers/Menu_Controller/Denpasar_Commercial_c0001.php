<?php
        ...
        class Denpasar_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Denpasar Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Denpasar Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Denpasar_Commercial_v0001', $data);
