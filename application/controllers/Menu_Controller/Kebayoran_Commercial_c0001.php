<?php
        ...
        class Kebayoran_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Kebayoran Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Kebayoran Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Kebayoran_Commercial_v0001', $data);
