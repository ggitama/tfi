<?php
        ...
        class Stock_Aging_Store_c0062 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Stock Aging Store';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Stock Aging Store';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Stock_Aging_Store_v0062', $data);
