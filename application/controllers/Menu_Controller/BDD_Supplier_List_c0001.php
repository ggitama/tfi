<?php
        ...
        class BDD_Supplier_List_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'BDD Supplier List';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'BDD Supplier List';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/BDD_Supplier_List_v0001', $data);
