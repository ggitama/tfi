<?php
        ...
        class Plaza_Ambarukmo_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Plaza Ambarukmo Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Plaza Ambarukmo Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Plaza_Ambarukmo_Commercial_v0001', $data);
