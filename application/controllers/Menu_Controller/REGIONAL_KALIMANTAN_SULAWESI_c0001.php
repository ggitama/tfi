<?php
        ...
        class REGIONAL_KALIMANTAN_SULAWESI_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'REGIONAL KALIMANTAN & SULAWESI';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'REGIONAL KALIMANTAN & SULAWESI';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/REGIONAL_KALIMANTAN_SULAWESI_v0001', $data);
