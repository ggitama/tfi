<?php
        ...
        class Plaza_Ambarukmo_Yogyakarta_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Plaza Ambarukmo Yogyakarta Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Plaza Ambarukmo Yogyakarta Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Plaza_Ambarukmo_Yogyakarta_Inventory_v0001', $data);
