<?php
        ...
        class Madiun_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Madiun Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Madiun Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Madiun_Inventory_v0001', $data);
