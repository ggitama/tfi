<?php
        ...
        class Dukuh_Kupang_Surabaya_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Dukuh Kupang Surabaya Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Dukuh Kupang Surabaya Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Dukuh_Kupang_Surabaya_Inventory_v0001', $data);
