<?php
        ...
        class REGIONAL_JAKARTA_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'REGIONAL JAKARTA';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'REGIONAL JAKARTA';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/REGIONAL_JAKARTA_v0001', $data);
