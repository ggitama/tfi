<?php
        ...
        class ITC_Depok_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'ITC Depok Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'ITC Depok Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/ITC_Depok_Inventory_v0001', $data);
