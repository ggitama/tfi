<?php
        ...
        class RAW_Zero_Stock_Active_Item_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'RAW Zero Stock Active Item';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'RAW Zero Stock Active Item';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/RAW_Zero_Stock_Active_Item_v0001', $data);
