<?php
        ...
        class Lampung_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Lampung Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Lampung Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Lampung_Inventory_v0001', $data);
