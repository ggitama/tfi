<?php
        ...
        class Tegal_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Tegal Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Tegal Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Tegal_Inventory_v0001', $data);
