<?php
        ...
        class Pekanbaru_Sukarno_Hatta_Stock_Over_or_Under_Store_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Pekanbaru Sukarno Hatta Stock Over or Under Store';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Pekanbaru Sukarno Hatta Stock Over or Under Store';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Pekanbaru_Sukarno_Hatta_Stock_Over_or_Under_Store_v0001', $data);
