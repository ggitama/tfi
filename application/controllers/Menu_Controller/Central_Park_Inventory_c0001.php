<?php
        ...
        class Central_Park_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Central Park Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Central Park Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Central_Park_Inventory_v0001', $data);
