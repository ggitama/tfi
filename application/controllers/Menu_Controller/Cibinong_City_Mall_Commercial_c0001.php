<?php
        ...
        class Cibinong_City_Mall_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Cibinong City Mall Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Cibinong City Mall Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Cibinong_City_Mall_Commercial_v0001', $data);
