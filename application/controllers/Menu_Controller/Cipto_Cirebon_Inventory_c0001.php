<?php
        ...
        class Cipto_Cirebon_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Cipto Cirebon Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Cipto Cirebon Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Cipto_Cirebon_Inventory_v0001', $data);
