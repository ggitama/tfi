<?php
        ...
        class Pabelan_Solo_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Pabelan Solo Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Pabelan Solo Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Pabelan_Solo_Inventory_v0001', $data);
