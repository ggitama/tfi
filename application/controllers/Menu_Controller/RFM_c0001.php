<?php
        ...
        class RFM_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                if ($get_data_iframe) {
                    ...
                    $data['iframe_tag'] = '<iframe title="Report Section" width="97%" height="4000" src="https://app.powerbi.com/view?r=eyJrIjoiOWRhZmQ4NjAtNjQ0My00OWEwLTg4ZTMtN2NhNzU2MjhlM2FmIiwidCI6ImY2NjIxNTQ3LTI3MjQtNDU0Ny1iYzA3LTZlNTA3ZjYxMmVhNiIsImMiOjEwfQ%3D%3D" frameborder="0" allowFullScreen="true"></iframe>';
                } else {
                    $data['iframe_name'] = '';
                ...
                $this->load->view('Menu_View/RFM_v0001', $data);
