<?php
        ...
        class Karawang_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Karawang Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Karawang Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Karawang_Inventory_v0001', $data);
