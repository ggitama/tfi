<?php
        ...
        class Link_Karebosi_MKS_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Link Karebosi MKS Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Link Karebosi MKS Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Link_Karebosi_MKS_Commercial_v0001', $data);
