<?php
        ...
        class PERFORMANCE_OVERVIEW_PART_2_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                if ($get_data_iframe) {
                    ...
                    $data['iframe_tag'] = '<iframe title="Report Section" width="97%" height="4000" src="https://app.powerbi.com/view?r=eyJrIjoiYzdiODQ4ZjAtYTExZS00ZWE1LWE3Y2EtNTg4Y2IwMWZmNmIyIiwidCI6ImY2NjIxNTQ3LTI3MjQtNDU0Ny1iYzA3LTZlNTA3ZjYxMmVhNiIsImMiOjEwfQ%3D%3D" frameborder="0" allowFullScreen="true"></iframe>';
                } else {
                    $data['iframe_name'] = '';
                ...
                $data['menus'] = $menu;
                $data['title'] = 'PERFORMANCE OVERVIEW PART 2';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'PERFORMANCE OVERVIEW PART 2';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/PERFORMANCE_OVERVIEW_PART_2_v0001', $data);
