<?php
        ...
        class Bekasi_Juanda_Inventory_Stock_Aging_Store_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Bekasi Juanda Inventory Stock Aging Store';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Bekasi Juanda Inventory Stock Aging Store';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Bekasi_Juanda_Inventory_Stock_Aging_Store_v0001', $data);
