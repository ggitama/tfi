<?php
        ...
        class Dashboard_Smart_Sales_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Dashboard Smart Sales';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Dashboard Smart Sales';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Dashboard_Smart_Sales_v0001', $data);
