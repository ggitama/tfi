<?php
        ...
        class Serang_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Serang Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Serang Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Serang_Commercial_v0001', $data);
