<?php
        ...
        class Permata_Hijau_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Permata Hijau Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Permata Hijau Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Permata_Hijau_Commercial_v0001', $data);
