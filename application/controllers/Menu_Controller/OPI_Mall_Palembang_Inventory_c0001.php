<?php
        ...
        class OPI_Mall_Palembang_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'OPI Mall Palembang Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'OPI Mall Palembang Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/OPI_Mall_Palembang_Inventory_v0001', $data);
