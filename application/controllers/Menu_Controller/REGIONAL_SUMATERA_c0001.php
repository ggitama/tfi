<?php
        ...
        class REGIONAL_SUMATERA_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'REGIONAL SUMATERA';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'REGIONAL SUMATERA';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/REGIONAL_SUMATERA_v0001', $data);
