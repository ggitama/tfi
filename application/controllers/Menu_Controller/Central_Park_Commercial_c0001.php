<?php
        ...
        class Central_Park_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Central Park Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Central Park Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Central_Park_Commercial_v0001', $data);
