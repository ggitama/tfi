<?php
        ...
        class Cipadung_Bandung_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Cipadung Bandung Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Cipadung Bandung Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Cipadung_Bandung_Commercial_v0001', $data);
