<?php
        ...
        class Sales_Report_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                if ($get_data_iframe) {
                    ...
                    $data['iframe_tag'] = '<iframe    src="https://transmart.bankmega.com/public/question/7d776edf-ff57-4eb5-b59f-2a14a7dbff86"    frameborder="0"    width="100%"    height="1200"    allowtransparency></iframe>';
                } else {
                    $data['iframe_name'] = '';
                ...
                $data['main_menu'] = 'Sales Report';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Sales_Report_v0001', $data);
