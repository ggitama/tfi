<?php
        ...
        class Balikpapan_Daun_Village_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Balikpapan Daun Village Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Balikpapan Daun Village Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Balikpapan_Daun_Village_Commercial_v0001', $data);
