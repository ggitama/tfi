<?php
        ...
        class Transmart_Tasikmalaya_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Transmart Tasikmalaya Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Transmart Tasikmalaya Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Transmart_Tasikmalaya_Commercial_v0001', $data);
