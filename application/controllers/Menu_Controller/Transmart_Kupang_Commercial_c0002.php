<?php
        ...
        class Transmart_Kupang_Commercial_c0002 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Transmart Icon Surabaya Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Transmart Icon Surabaya Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Transmart_Kupang_Commercial_v0002', $data);
