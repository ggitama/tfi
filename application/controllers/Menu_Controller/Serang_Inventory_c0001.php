<?php
        ...
        class Serang_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Serang Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Serang Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Serang_Inventory_v0001', $data);
