<?php
        ...
        class Rank_by_Sales_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                if ($get_data_iframe) {
                    ...
                    $data['iframe_tag'] = '<iframe    src="https://transmart.bankmega.com/public/question/6c7ada1a-a5ff-4299-b14d-6f9cd0411d0d"    frameborder="0"    width="100%"    height="1200"    allowtransparency></iframe>'; 
                } else {
                    $data['iframe_name'] = '';
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Rank by Sales';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Rank by Sales';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Rank_by_Sales_v0001', $data);
