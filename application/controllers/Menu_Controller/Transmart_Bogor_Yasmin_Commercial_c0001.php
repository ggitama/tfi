<?php
        ...
        class Transmart_Bogor_Yasmin_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Transmart Bogor Yasmin Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Transmart Bogor Yasmin Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Transmart_Bogor_Yasmin_Commercial_v0001', $data);
