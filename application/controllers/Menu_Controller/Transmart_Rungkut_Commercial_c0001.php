<?php
        ...
        class Transmart_Rungkut_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Transmart Rungkut Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Transmart Rungkut Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Transmart_Rungkut_Commercial_v0001', $data);
