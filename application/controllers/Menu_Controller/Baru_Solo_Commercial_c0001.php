<?php
        ...
        class Baru_Solo_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Baru Solo Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Baru Solo Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Baru_Solo_Commercial_v0001', $data);
