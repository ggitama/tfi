<?php
        ...
        class Blimbing_Malang_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Blimbing Malang Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Blimbing Malang Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Blimbing_Malang_Inventory_v0001', $data);
