<?php
        ...
        class Trans_Studio_MKS_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Trans Studio MKS Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Trans Studio MKS Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Trans_Studio_MKS_Commercial_v0001', $data);
