<?php
        ...
        class OPI_Mall_Palembang_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'OPI Mall Palembang Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'OPI Mall Palembang Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/OPI_Mall_Palembang_Commercial_v0001', $data);
