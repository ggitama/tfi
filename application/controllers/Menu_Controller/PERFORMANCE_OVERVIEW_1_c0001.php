<?php
        ...
        class PERFORMANCE_OVERVIEW_1_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                if ($get_data_iframe) {
                    ...
                    $data['iframe_tag'] = '<iframe title="Report Section"  src="https://app.powerbi.com/view?r=eyJrIjoiZjViYWFhMGItNDNhMC00ZmEwLTlkNzgtMjEyZjU2YWFlZTQwIiwidCI6ImY2NjIxNTQ3LTI3MjQtNDU0Ny1iYzA3LTZlNTA3ZjYxMmVhNiIsImMiOjEwfQ%3D%3D" frameborder="0" width="97%" height="4000" allowFullScreen="true"></iframe>';
                } else {
                    $data['iframe_name'] = '';
                ...
                $data['menus'] = $menu;
                $data['title'] = 'PERFORMANCE OVERVIEW 1';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'PERFORMANCE OVERVIEW 1';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/PERFORMANCE_OVERVIEW_1_v0001', $data);
