<?php
        ...
        class Store_Jabanusra_4_c0002 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Store Jabanusra 4';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Store Jabanusra 4';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Store_Jabanusra_4_v0002', $data);
