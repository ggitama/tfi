<?php
        ...
        class Operation_Summary_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Operation Summary';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Operation Summary';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Operation_Summary_v0001', $data);
