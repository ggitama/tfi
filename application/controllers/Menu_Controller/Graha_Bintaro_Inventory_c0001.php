<?php
        ...
        class Graha_Bintaro_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Graha Bintaro Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Graha Bintaro Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Graha_Bintaro_Inventory_v0001', $data);
