<?php
        ...
        class Blok_M_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Blok M Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Blok M Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Blok_M_Commercial_v0001', $data);
