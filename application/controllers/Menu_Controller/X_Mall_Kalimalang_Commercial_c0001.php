<?php
        ...
        class X_Mall_Kalimalang_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'X Mall Kalimalang Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'X Mall Kalimalang Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/X_Mall_Kalimalang_Commercial_v0001', $data);
