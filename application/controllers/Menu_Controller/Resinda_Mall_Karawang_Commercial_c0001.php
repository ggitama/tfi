<?php
        ...
        class Resinda_Mall_Karawang_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Resinda Mall Karawang Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Resinda Mall Karawang Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Resinda_Mall_Karawang_Commercial_v0001', $data);
