<?php
        ...
        class Karawang_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Karawang Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Karawang Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Karawang_Commercial_v0001', $data);
