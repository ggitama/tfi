<?php
        ...
        class Mangga_Dua_Square_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Mangga Dua Square Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Mangga Dua Square Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Mangga_Dua_Square_Commercial_v0001', $data);
