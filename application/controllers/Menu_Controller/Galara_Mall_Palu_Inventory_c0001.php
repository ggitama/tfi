<?php
        ...
        class Galara_Mall_Palu_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Galara Mall Palu Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Galara Mall Palu Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Galara_Mall_Palu_Inventory_v0001', $data);
