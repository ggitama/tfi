<?php
        ...
        class Trans_Icon_Surabaya_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Trans Icon Surabaya Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Trans Icon Surabaya Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Trans_Icon_Surabaya_Inventory_v0001', $data);
