<?php
        ...
        class PL_by_Division_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'PL by Division';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'PL by Division';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/PL_by_Division_v0001', $data);
