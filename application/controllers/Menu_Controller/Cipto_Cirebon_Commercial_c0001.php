<?php
        ...
        class Cipto_Cirebon_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Cipto Cirebon Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Cipto Cirebon Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Cipto_Cirebon_Commercial_v0001', $data);
