<?php
        ...
        class Keppel_Bubutan_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Keppel Bubutan Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Keppel Bubutan Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Keppel_Bubutan_Commercial_v0001', $data);
