<?php
        ...
        class REGIONAL_COMMERCIAL_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'REGIONAL COMMERCIAL';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'REGIONAL COMMERCIAL';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/REGIONAL_COMMERCIAL_v0001', $data);
