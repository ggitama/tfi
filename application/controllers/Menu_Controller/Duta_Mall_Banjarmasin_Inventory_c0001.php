<?php
        ...
        class Duta_Mall_Banjarmasin_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Duta Mall Banjarmasin Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Duta Mall Banjarmasin Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Duta_Mall_Banjarmasin_Inventory_v0001', $data);
