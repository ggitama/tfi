<?php
        ...
        class Transmart_Cibubur_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Transmart Cibubur Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Transmart Cibubur Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Transmart_Cibubur_Commercial_v0001', $data);
