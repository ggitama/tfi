<?php
        ...
        class Palembang_City_Center_Inventory_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Palembang City Center Inventory';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Palembang City Center Inventory';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Palembang_City_Center_Inventory_v0001', $data);
