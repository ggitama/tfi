<?php
        ...
        class Kawanua_Manado_Commercial_c0001 extends CI_Controller
        {
            ...
            public function index()
            {
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Kawanua Manado Commercial';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Kawanua Manado Commercial';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Menu_View/Kawanua_Manado_Commercial_v0001', $data);
