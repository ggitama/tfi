<?php
        ...
        class Store_Link_Karebosi_MKS extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Link Karebosi MKS';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Link Karebosi MKS';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_sumkalsul_1/Store_Link_Karebosi_MKS_v', $data);
