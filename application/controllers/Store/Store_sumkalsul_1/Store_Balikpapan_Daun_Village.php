<?php
        ...
        class Store_Balikpapan_Daun_Village extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Balikpapan Daun Village';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Balikpapan Daun Village';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_sumkalsul_1/Store_Balikpapan_Daun_Village_v', $data);
