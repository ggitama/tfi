<?php
        ...
        class Store_Pengayoman_Makassar extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Pengayoman Makassar';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Pengayoman Makassar';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_sumkalsul_1/Store_Pengayoman_Makassar_v', $data);
