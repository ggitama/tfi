<?php
        ...
        class Store_Trans_Studio_MKS extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Trans Studio MKS';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Trans Studio MKS';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_sumkalsul_1/Store_Trans_Studio_MKS_v', $data);
