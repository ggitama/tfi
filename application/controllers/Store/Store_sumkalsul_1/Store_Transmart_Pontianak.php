<?php
        ...
        class Store_Transmart_Pontianak extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Transmart Pontianak';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Transmart Pontianak';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_sumkalsul_1/Store_Transmart_Pontianak_v', $data);
