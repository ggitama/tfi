<?php
        ...
        class Store_Transmart_DutaMall_Banjarmasin extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'DutaMall Banjarmasin';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'DutaMall Banjarmasin';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_sumkalsul_1/Store_Transmart_DutaMall_Banjarmasin_v', $data);
