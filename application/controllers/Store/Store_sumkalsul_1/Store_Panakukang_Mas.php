<?php
        ...
        class Store_Panakukang_Mas extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Panakukang Mas';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Panakukang Mas';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_sumkalsul_1/Store_Panakukang_Mas_v', $data);
