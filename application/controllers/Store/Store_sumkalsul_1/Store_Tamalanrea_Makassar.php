<?php
        ...
        class Store_Tamalanrea_Makassar extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Tamalanrea Makassar';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Tamalanrea Makassar';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_sumkalsul_1/Store_Tamalanrea_Makassar_v', $data);
