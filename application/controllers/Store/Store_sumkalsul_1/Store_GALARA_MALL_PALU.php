<?php
        ...
        class Store_GALARA_MALL_PALU extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'GALARA MALL PALU';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'GALARA MALL PALU';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_sumkalsul_1/Store_GALARA_MALL_PALU_v', $data);
