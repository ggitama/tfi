...
class Store_Icon_Surabaya extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['menus'] = $menu;
        $data['title'] = 'Transmart Icon Surabaya';
        $data['menu_header'] = 'Dashboard';
        $data['main_menu'] = 'Transmart Icon Surabaya';

        $this->load->view('template_dashboard/Header_v', $data);
        $this->load->view('Store/Store_jabanusra_3/Store_Icon_Surabaya_v', $data);
