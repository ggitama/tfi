<?php
        ...
        class Store_Transmart_Ngagel_Surabaya extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Transmart Ngagel Surabaya';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Transmart Ngagel Surabaya';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jabanusra_3/Store_Transmart_Ngagel_Surabaya_v', $data);
