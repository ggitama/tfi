<?php
        ...
        class Store_Keppel_Bubutan extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Keppel Bubutan';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Keppel Bubutan';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jabanusra_3/Store_Keppel_Bubutan_v', $data);
