<?php
        ...
        class Store_Bonjol_Denpasar extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Bonjol Denpasar';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Bonjol Denpasar';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jabanusra_3/Store_Bonjol_Denpasar_v', $data);
