<?php
        ...
        class Store_Transmart_Rungkut extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Transmart Rungkut';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Transmart Rungkut';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jabanusra_3/Store_Transmart_Rungkut_v', $data);
