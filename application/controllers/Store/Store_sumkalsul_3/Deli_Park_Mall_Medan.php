...
class Deli_Park_Mall_Medan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['menus'] = $menu;
        $data['title'] = 'Deli Park Mall Medan';
        $data['menu_header'] = 'Dashboard';
        $data['main_menu'] = 'Deli Park Mall Medan';

        $this->load->view('template_dashboard/Header_v', $data);
        $this->load->view('Store/Store_sumkalsul_3/Store_Deli_Park_Mall_Medan_v', $data);
