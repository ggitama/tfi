<?php
        ...
        class Store_Transmart_Padang extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Transmart Padang';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Transmart Padang';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_sumkalsul_3/Store_Transmart_Padang_v', $data);
