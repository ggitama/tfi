<?php
        ...
        class Store_Pekanbaru_Soekarno_Hatta extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Pekanbaru Soekarno Hatta';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Pekanbaru Soekarno Hatta';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_sumkalsul_3/Store_Pekanbaru_Soekarno_Hatta_v', $data);
