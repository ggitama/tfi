<?php
        ...
        class Store_OPI_Mall_Palembang extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'OPI Mall Palembang';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'OPI Mall Palembang';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_sumkalsul_3/Store_OPI_Mall_Palembang_v', $data);
