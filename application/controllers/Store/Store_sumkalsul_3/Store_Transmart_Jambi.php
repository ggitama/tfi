<?php
        ...
        class Store_Transmart_Jambi extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Transmart Jambi';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Transmart Jambi';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_sumkalsul_3/Store_Transmart_Jambi_v', $data);
