<?php
        ...
        class Store_Palembang_City_Center extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Palembang City Center';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Palembang City Center';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_sumkalsul_3/Store_Palembang_City_Center_v', $data);
