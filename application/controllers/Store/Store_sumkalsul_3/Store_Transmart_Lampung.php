<?php
        ...
        class Store_Transmart_Lampung extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Transmart Lampung';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Transmart Lampung';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_sumkalsul_3/Store_Transmart_Lampung_v', $data);
