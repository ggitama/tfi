<?php
        ...
        class Store_Medan_Citra extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Medan Citra';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Medan Citra';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_sumkalsul_3/Store_Medan_Citra_v', $data);
