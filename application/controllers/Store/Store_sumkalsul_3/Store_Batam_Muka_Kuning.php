<?php
        ...
        class Store_Batam_Muka_Kuning extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Batam Muka Kuning';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Batam Muka Kuning';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_sumkalsul_3/Store_Batam_Muka_Kuning_v', $data);
