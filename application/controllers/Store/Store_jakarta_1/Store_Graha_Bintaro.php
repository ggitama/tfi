<?php
        ...
        class Store_Graha_Bintaro extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Graha Bintaro';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Graha Bintaro';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jakarta_1/Store_Graha_Bintaro_v', $data);
