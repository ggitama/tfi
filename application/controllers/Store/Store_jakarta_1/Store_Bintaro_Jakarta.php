<?php
        ...
        class Store_Bintaro_Jakarta extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Bintaro Jakarta';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Bintaro Jakarta';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jakarta_1/Store_Bintaro_Jakarta_v', $data);
