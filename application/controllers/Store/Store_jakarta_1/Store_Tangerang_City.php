...
class Store_Tangerang_City extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['menus'] = $menu;
        $data['title'] = 'Tangerang City';
        $data['menu_header'] = 'Dashboard';
        $data['main_menu'] = 'Tangerang City';

        $this->load->view('template_dashboard/Header_v', $data);
        $this->load->view('Store/Store_jakarta_1/Store_Tangerang_City_v', $data);
