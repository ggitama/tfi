<?php
        ...
        class Store_Cempaka_Putih extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Cempaka Putih';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Cempaka Putih';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jakarta_1/Store_Cempaka_Putih_v', $data);
