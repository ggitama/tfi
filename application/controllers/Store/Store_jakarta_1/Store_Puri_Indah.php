<?php
        ...
        class Store_Puri_Indah extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Puri Indah';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Puri Indah';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jakarta_1/Store_Puri_Indah_v', $data);
