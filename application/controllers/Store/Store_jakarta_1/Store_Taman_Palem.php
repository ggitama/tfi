<?php
        ...
        class Store_Taman_Palem extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Taman Palem';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Taman Palem';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jakarta_1/Store_Taman_Palem_v', $data);
