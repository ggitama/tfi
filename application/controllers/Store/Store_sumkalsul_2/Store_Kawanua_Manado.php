<?php
        ...
        class Store_Kawanua_Manado extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Kawanua Manado';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Kawanua Manado';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_sumkalsul_2/Store_Kawanua_Manado_v', $data);
