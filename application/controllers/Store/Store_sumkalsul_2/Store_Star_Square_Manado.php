<?php
        ...
        class Store_Star_Square_Manado extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Star Square Manado';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Star Square Manado';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_sumkalsul_2/Store_Star_Square_Manado_v', $data);
