<?php
        ...
        class Store_Mangga_Dua_Square extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Mangga Dua Square';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Mangga Dua Square';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jakarta_2/Store_Mangga_Dua_Square_v', $data);
