<?php
        ...
        class Store_Megamall_Pluit extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Megamall Pluit';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Megamall Pluit';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jakarta_2/Store_Megamall_Pluit_v', $data);
