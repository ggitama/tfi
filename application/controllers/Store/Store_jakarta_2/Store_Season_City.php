<?php
        ...
        class Store_Season_City extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Season City';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Season City';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jakarta_2/Store_Season_City_v', $data);
