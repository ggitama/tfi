<?php
        ...
        class Store_Permata_Hijau extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Permata Hijau';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Permata Hijau';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jakarta_2/Store_Permata_Hijau_v', $data);
