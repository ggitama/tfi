<?php
        ...
        class Store_Transmart_Gresik_Icon extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Transmart Gresik Icon';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Transmart Gresik Icon';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jabanusra_2/Store_Transmart_Gresik_Icon_v', $data);
