<?php
        ...
        class Store_Blimbing_Malang extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Blimbing Malang';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Blimbing Malang';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jabanusra_2/Store_Blimbing_Malang_v', $data);
