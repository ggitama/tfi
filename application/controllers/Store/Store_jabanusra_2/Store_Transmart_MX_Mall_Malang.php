<?php
        ...
        class Store_Transmart_MX_Mall_Malang extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Transmart MX Mall Malang';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Transmart MX Mall Malang';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jabanusra_2/Store_Transmart_MX_Mall_Malang_v', $data);
