<?php
        ...
        class Store_Transmart_Mataram extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Transmart Mataram';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Transmart Mataram';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jabanusra_2/Store_Transmart_Mataram_v', $data);
