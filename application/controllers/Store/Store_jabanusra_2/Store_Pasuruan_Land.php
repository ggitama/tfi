<?php
        ...
        class Store_Pasuruan_Land extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Pasuruan Land';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Pasuruan Land';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jabanusra_2/Store_Pasuruan_Land_v', $data);
