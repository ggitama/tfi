<?php
        ...
        class Store_Hayam_Wuruk_Jember extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Hayam Wuruk Jember';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Hayam Wuruk Jember';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jabanusra_2/Store_Hayam_Wuruk_Jember_v', $data);
