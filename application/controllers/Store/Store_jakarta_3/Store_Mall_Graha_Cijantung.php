<?php
        ...
        class Store_Mall_Graha_Cijantung extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Mall Graha Cijantung';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Mall Graha Cijantung';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jakarta_3/Store_Mall_Graha_Cijantung_v', $data);
