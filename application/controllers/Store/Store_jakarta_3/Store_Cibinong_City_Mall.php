<?php
        ...
        class Store_Cibinong_City_Mall extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Cibinong City Mall';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Cibinong City Mall';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jakarta_3/Store_Cibinong_City_Mall_v', $data);
