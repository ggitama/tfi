<?php
        ...
        class Store_Kramatjati_Indah extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Kramatjati Indah';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Kramatjati Indah';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jakarta_3/Store_Kramatjati_Indah_v', $data);
