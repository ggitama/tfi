<?php
        ...
        class Store_Transmart_Cibubur extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Transmart Cibubur';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Transmart Cibubur';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jakarta_3/Store_Transmart_Cibubur_v', $data);
