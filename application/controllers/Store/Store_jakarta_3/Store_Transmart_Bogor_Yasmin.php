<?php
        ...
        class Store_Transmart_Bogor_Yasmin extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Transmart Bogor Yasmin';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Transmart Bogor Yasmin';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jakarta_3/Store_Transmart_Bogor_Yasmin_v', $data);
