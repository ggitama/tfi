<?php
        ...
        class Store_Airforce_Mart_Halim extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Airforce Mart Halim';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Airforce Mart Halim';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jakarta_3/Store_Airforce_Mart_Halim_v', $data);
