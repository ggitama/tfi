...
class Store_MT_Haryono extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['menus'] = $menu;
        $data['title'] = 'MT. Haryono';
        $data['menu_header'] = 'Dashboard';
        $data['main_menu'] = 'MT. Haryono';

        $this->load->view('template_dashboard/Header_v', $data);
        $this->load->view('Store/Store_jakarta_3/Store_MT_Haryono_v', $data);
