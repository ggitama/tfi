<?php
        ...
        class Store_Dewi_Sartika_Depok extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Dewi Sartika Depok';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Dewi Sartika Depok';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jakarta_3/Store_Dewi_Sartika_Depok_v', $data);
