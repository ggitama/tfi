<?php
        ...
        class Store_Kota_Kasablanka extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Kota Kasablanka';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Kota Kasablanka';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jakarta_3/Store_Kota_Kasablanka_v', $data);
