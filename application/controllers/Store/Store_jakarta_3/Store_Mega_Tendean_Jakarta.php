<?php
        ...
        class Store_Mega_Tendean_Jakarta extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Mega Tendean Jakarta';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Mega Tendean Jakarta';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jakarta_3/Store_Mega_Tendean_Jakarta_v', $data);
