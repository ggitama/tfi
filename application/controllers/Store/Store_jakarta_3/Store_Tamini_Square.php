<?php
        ...
        class Store_Tamini_Square extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Tamini Square';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Tamini Square';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jakarta_3/Store_Tamini_Square_v', $data);
