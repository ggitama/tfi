<?php
        ...
        class Store_Cempaka_Mas extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Cempaka Mas';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Cempaka Mas';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jakarta_4/Store_Cempaka_Mas_v', $data);
