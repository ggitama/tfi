<?php
        ...
        class Store_Bekasi_Harapan extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Bekasi Harapan';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Bekasi Harapan';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jakarta_4/Store_Bekasi_Harapan_v', $data);
