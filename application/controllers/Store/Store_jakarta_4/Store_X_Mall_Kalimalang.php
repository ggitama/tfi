...
class Store_X_Mall_Kalimalang extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['menus'] = $menu;
        $data['title'] = 'X-Mall Kalimalang';
        $data['menu_header'] = 'Dashboard';
        $data['main_menu'] = 'X-Mall Kalimalang';

        $this->load->view('template_dashboard/Header_v', $data);
        $this->load->view('Store/Store_jakarta_4/Store_X_Mall_Kalimalang_v', $data);
