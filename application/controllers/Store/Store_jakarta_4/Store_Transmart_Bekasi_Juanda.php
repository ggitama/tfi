<?php
        ...
        class Store_Transmart_Bekasi_Juanda extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Transmart Bekasi Juanda';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Transmart Bekasi Juanda';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jakarta_4/Store_Transmart_Bekasi_Juanda_v', $data);
