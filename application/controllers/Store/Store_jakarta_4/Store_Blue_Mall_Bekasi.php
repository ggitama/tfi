<?php
        ...
        class Store_Blue_Mall_Bekasi extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Blue Mall Bekasi';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Blue Mall Bekasi';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jakarta_4/Store_Blue_Mall_Bekasi_v', $data);
