<?php
        ...
        class Store_Atrium_Pondok_Gede extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Atrium Pondok Gede';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Atrium Pondok Gede';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jakarta_4/Store_Atrium_Pondok_Gede_v', $data);
