<?php
        ...
        class Store_Sunter_Jakarta extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Sunter Jakarta';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Sunter Jakarta';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jakarta_4/Store_Sunter_Jakarta_v', $data);
