<?php
        ...
        class Store_Cipto_Cirebon extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Cipto Cirebon';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Cipto Cirebon';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jabanusra_1/Store_Cipto_Cirebon_v', $data);
