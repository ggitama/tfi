<?php
        ...
        class Store_Transmart_Pekalongan extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Transmart Pekalongan';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Transmart Pekalongan';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jabanusra_1/Store_Transmart_Pekalongan_v', $data);
