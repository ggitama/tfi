<?php
        ...
        class Store_Transmart_Majapahit_Semarang extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Transmart Majapahit Semarang';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Transmart Majapahit Semarang';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jabanusra_1/Store_Transmart_Majapahit_Semarang_v', $data);
