<?php
        ...
        class Store_Cipadung_Bandung extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Cipadung Bandung';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Cipadung Bandung';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jabanusra_1/Store_Cipadung_Bandung_v', $data);
