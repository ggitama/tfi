<?php
        ...
        class Store_Semarang_Srondol extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Semarang Srondol';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Semarang Srondol';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jabanusra_1/Store_Semarang_Srondol_v', $data);
