<?php
        ...
        class Store_Kiara_Condong extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Kiara Condong';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Kiara Condong';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jabanusra_1/Store_Kiara_Condong_v', $data);
