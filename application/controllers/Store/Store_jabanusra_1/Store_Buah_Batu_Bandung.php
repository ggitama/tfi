<?php
        ...
        class Store_Buah_Batu_Bandung extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Buah Batu Bandung';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Buah Batu Bandung';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jabanusra_1/Store_Buah_Batu_Bandung_v', $data);
