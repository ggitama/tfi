<?php
        ...
        class Store_Transmart_Tasikmalaya extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Transmart Tasikmalaya';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Transmart Tasikmalaya';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jabanusra_4/Store_Transmart_Tasikmalaya_v', $data);
