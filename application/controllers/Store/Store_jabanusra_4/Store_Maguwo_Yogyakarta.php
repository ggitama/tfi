<?php
        ...
        class Store_Maguwo_Yogyakarta extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Maguwo Yogyakarta';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Maguwo Yogyakarta';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jabanusra_4/Store_Maguwo_Yogyakarta_v', $data);
