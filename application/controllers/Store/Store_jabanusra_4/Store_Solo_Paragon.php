<?php
        ...
        class Store_Solo_Paragon extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Solo Paragon';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Solo Paragon';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jabanusra_4/Store_Solo_Paragon_v', $data);
