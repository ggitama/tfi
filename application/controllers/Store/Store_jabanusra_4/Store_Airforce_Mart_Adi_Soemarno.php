<?php
        ...
        class Store_Airforce_Mart_Adi_Soemarno extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Airforce Mart Adi Soemarno';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Airforce Mart Adi Soemarno';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jabanusra_4/Store_Airforce_Mart_Adi_Soemarno_v', $data);
