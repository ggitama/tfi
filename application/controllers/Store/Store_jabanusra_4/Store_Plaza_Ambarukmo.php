<?php
        ...
        class Store_Plaza_Ambarukmo extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Plaza Ambarukmo';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Plaza Ambarukmo';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jabanusra_4/Store_Plaza_Ambarukmo_v', $data);
