<?php
        ...
        class Store_Magelang_Armada extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Magelang Armada';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Magelang Armada';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jabanusra_4/Store_Magelang_Armada_v', $data);
