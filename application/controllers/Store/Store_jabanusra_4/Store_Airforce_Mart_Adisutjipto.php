<?php
        ...
        class Store_Airforce_Mart_Adisutjipto extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Airforce Mart Adisutjipto';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Airforce Mart Adisutjipto';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jabanusra_4/Store_Airforce_Mart_Adisutjipto_v', $data);
