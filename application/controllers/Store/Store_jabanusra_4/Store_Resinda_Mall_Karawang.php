<?php
        ...
        class Store_Resinda_Mall_Karawang extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Resinda Mall Karawang';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Resinda Mall Karawang';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jabanusra_4/Store_Resinda_Mall_Karawang_v', $data);
