<?php
        ...
        class Store_Pabelan_Solo extends CI_Controller
        {
            ...
            $data['iframe_tag'] = "tidak ada tampilan dashboard untuk anda";
                ...
                $data['menus'] = $menu;
                $data['title'] = 'Pabelan Solo';
                $data['menu_header'] = 'Dashboard';
                $data['main_menu'] = 'Pabelan Solo';
        
                $this->load->view('template_dashboard/Header_v', $data);
                $this->load->view('Store/Store_jabanusra_4/Store_Pabelan_Solo_v', $data);
