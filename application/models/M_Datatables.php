<?php
    ...
    class M_Datatables extends CI_Model
    {
        ...
        {
            parent::__construct();
            // $this->db = $this->load->database('training', TRUE);
        }
        ...
        function get_tables_query($query,$cari,$where,$iswhere)
        {
            ...
            if ($limit == '1') {
                ...
                $limit_cond = " LIMIT ".$limit." OFFSET ".$start;
            }
            ...
            if($where != null)
            {
                ...
                if(!empty($iswhere))
                {
                    $sql_data = $this->db->query($query." WHERE $iswhere AND ".$fwhere." AND (".$cari.")".$order.$limit_cond);
                }else{
                    $sql_data = $this->db->query($query." WHERE ".$fwhere." AND (".$cari.")".$order.$limit_cond);
                }
                ...
                if(!empty($iswhere))
                {                
                    $sql_data = $this->db->query($query." WHERE $iswhere AND (".$cari.")".$order.$limit_cond);
                }else{
                    $sql_data = $this->db->query($query." WHERE (".$cari.")".$order.$limit_cond);
                }
        ...
        function get_tables_query_train($query,$cari,$where,$iswhere)
        {
            // Ambil data yang di ketik user pada textbox pencarian
            // $a1=array("red","green");
            ...
            if ($limit == '1') {
                ...
                $condition_limit = " LIMIT ".$limit." OFFSET ".$start;
            }
            ...
            if($where != null)
            {
                ...
                if(!empty($iswhere))
                {
                    $sql_data = $this->db->query($query." WHERE $iswhere AND ".$fwhere." AND (".$cari.")".$order.$condition_limit);
                }else{
                    $sql_data = $this->db->query($query." WHERE ".$fwhere." AND (".$cari.")".$order.$condition_limit);
                }
                ...
                if(!empty($iswhere))
                {                
                    $sql_data = $this->db->query($query." WHERE $iswhere AND (".$cari.")".$order.$condition_limit);
                }else{
                    $sql_data = $this->db->query($query." WHERE (".$cari.")".$order.$condition_limit);
                }
